================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : FliteMFC Project Overview
===============================================================================

The application wizard has created this FliteMFC application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your FliteMFC application.
...
FliteMFC.h
    ...
    project specific headers and declares the CFliteMFCApp application class.
...
FliteMFCDoc.h, FliteMFCDoc.cpp - the document
    These files contain your CFliteMFCDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CFliteMFCDoc::Serialize).

FliteMFCView.h, FliteMFCView.cpp - the view of the document
    These files contain your CFliteMFCView class.
    CFliteMFCView objects are used to view CFliteMFCDoc objects.
...
StdAfx.h, StdAfx.cpp
    ...
    named FliteMFC.pch and a precompiled types file named StdAfx.obj.
